...
export const headerCells = ['Game', 'Date', 'Matchup', 'W/L', 'Min', 'FGM', 'FGA', 'FG%',
...
export const statsFields = ['game_date', 'matchup', 'wl', 'min', 'fgm', 'fga', 'fg_pct',
...
export const nonPerGameFields = ['Field Goal Percentage', 'Three Point Percentage',
  'Free Throw Percentage', 'Plus/Minus'];
