                ...
                .then(res => {
                    ...
                    res.data.forEach((player, i) => {
                        players.push({
                            ...
                            lastFirst: player.lastFirst,
                            key: `${player.first} ${player.last}-${i}`,
                            id: `${player.id}`,
                        });
                    });
        ...
        return (
            <Search
                ...
                results={filterResults(
                    this.props.players,
                    this.state.currentInput,
                    this.setCurrentPlayer.bind(this),
                    this.props.setPlayerBio.bind(this)
                )}
            />
        );
    }
