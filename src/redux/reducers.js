...
export function players(state = initialPlayersState, action) {
    switch (action.type) {
        ...
        case types.SET_HIGHLIGHT_WL:
            return Object.assign({}, state, {
                highlightWL: action.highlightWL,
            });
        ...
        case types.SET_PLAYER_CUMULATIVE_AVERAGE_GAME_LOG:
            return Object.assign({}, state, {
                [action.gameLogType]: {
                    ...state[action.gameLogType],
                    playerCumulativeAverageGameLog:
                        action.playerCumulativeAverageGameLog,
                },
            });
            ...
            return Object.assign({}, state, {
                [action.gameLogType]: {
                    ...
                    playerCumulativeTotalGameLog:
                        action.playerCumulativeTotalGameLog,
                },
            });
        case types.SET_PLAYER_GAME_LOG:
            return Object.assign({}, state, {
                [action.gameLogType]: {
                    ...state[action.gameLogType],
                    playerGameLog: action.playerGameLog,
                },
            });
...
export function ui(state = initialUiState, action) {
    switch (action.type) {
        case types.SET_CHOSEN_LETTER:
            return Object.assign({}, state, {
                chosenLetter: action.chosenLetter,
            });
        case types.SET_PLAYER_ERROR:
            return Object.assign({}, state, {
                playerError: action.playerError,
            });
        default:
            return state;
    }
